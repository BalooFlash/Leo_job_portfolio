...
const About = () => {
  ...
  const skills = ['Rust', 'Golang', 'Nodejs', 'Java', 'Python', "Django/Flask" , 'Kubernet', 'C#', '.Net', 'Firebase',  'WebAssemble', 'Javascript', 'Typescript', 'React', 'Vue', 'Next','Solidity', 'Web3', 'Solana','Cosmos', 'SQL', 'NoSQL', 'AWS',];
